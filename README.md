...
> **The Ultimate Collection of 925+ Universal Agentic Skills for AI Coding Assistants — Claude Code, Gemini CLI, Codex CLI, Antigravity IDE, GitHub Copilot, Cursor, OpenCode, AdaL**
...
**Antigravity Awesome Skills** is a curated, battle-tested library of **925 high-performance agentic skills** designed to work seamlessly across all major AI coding assistants:
...
- [📚 Browse 925+ Skills](#browse-925-skills)
